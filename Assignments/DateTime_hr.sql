...
-- 3. Write a query to get the distinct Mondays from hire_date in employees 
-- tables.
...
-- Output : 2000-07-11
-- Date and Time functions
-- 11. Write a query to get the first name and hire date from employees table where 
...
-- 19. Write a query to get employee ID, last name, and date of first salary of the 
-- employees.
-- Sample table : employees
